...
class Produit extends \App\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'image', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'qte', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'paniers'];
        }
     ...
     * {@inheritDoc}
     */
    public function setQte(?string $qte): \App\Entity\Produit
    {
    ...
    public function __toFloat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, '__toFloat', []);

        return parent::__toFloat();
    }
